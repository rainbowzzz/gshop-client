<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShopBrief=true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isActivitySheet=true">
    ...
    <div class="shop-brief-modal" style="display: none;" v-show="isShopBrief">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isShopBrief=false"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>
    <div class="activity-sheet" style="display: none;" v-show="isActivitySheet">
      <div class="activity-sheet-content" >
        ...
        <div class="activity-sheet-close" @click="isActivitySheet=false">
